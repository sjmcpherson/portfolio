...
<!--[if (gt IE 8)]><!--> <html class="no-js wf-loading">
<!--<![endif]-->
    <head>
...
<div class="wrap navedit">
    <nav id="nav" role="navigation" class="block">
        <ul class="menu block">
...
<a name="portfolio" id="portfolio"></a>
                ...
                <h2>My name is Stuart & I build websites & web apps that are a pleasure to use....</h2>          
...
<section class="wrap main">
                ...
                <div class="scale l4">                	
                    <ul><li><span>Jedi Master</span></li><li><span>Jedi Knight</span></li><li><span>Padawan</span></li><li class="endf"><span>Youngling</span></li></ul>
                </div>				
                </div>
                <!--
                 <ul class="graph">
...
<script src="js/controller.js"></script>  
        <script>		
            var _gaq=[['_setAccount','UA-40796844-1'],['_trackPageview']];
